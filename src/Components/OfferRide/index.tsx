...
const OfferRide: React.FC = () => {
    ...
    // const [offeringTime, setofferingTime] = useState<string>("");
    ...
    const manageShow = () => setopenEmp(x => !x);
    useEffect(() => {
    ...
    const addOfferRideBackend = async () => {
        if(userFromCity != userToCity){
            // axios.defaults.headers.common['Authorization'] = 'Bearer ' + {globalVariable};
            // axios.defaults.headers.common['Content-Type'] = 'application/json';
            await axiosInstance.post('http://localhost:5290/api/OfferRide/OfferingRide',
            {
            ...
            .then(e => {console.log(e); window.alert(" offer a ride succesfully");navigate("/dashboard")})
                ...
                <div>
                    <Row>
                        ...
                        <Row>
                                            ...
                                            <div>
                                                <form className="form-for-offering">
                                                    <div className="form-group">
                                                        <label className="from-label form--offerride float-left">From</label>
                                                        <select name="employeeDepartment" className="form-field-value-offerride" value={userFromCity}
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <select name="employeeDepartment" className="form-field-value-offerride" value={userToCity}
                                                    ...
                                                    <div className="form-group">
                                                        <Row>
                                                            <label className="time-label-offerride form-lables float-left">Time</label>
                                                        </Row>
                                                        <Row>
                                                            <div>
                                                                <button value={time} style={styleButton1} onClick={(event) => { handleTimeRequest(event, "5am-9am") }} className="time-slot-btn-offerride btn-default black-color time-slots-btns">5am-9am</button>


                                                                <button value={time} style={styleButton2} onClick={(event) => { handleTimeRequest(event, "9am-12pm") }} className="time-slot-btn-offerride btn-default black-color time-slots-btns">9am-12pm</button>

                                                                <button value={time} style={styleButton3} onClick={(event) => { handleTimeRequest(event, "12pm-3pm") }} className="time-slot-btn-offerride btn-default black-color time-slots-btns">12pm-3pm</button>
                                                        ...
                                                        <Row>
                                                            <div>
                                                                <button value={time} style={styleButton4} onClick={(event) => { handleTimeRequest(event, "3pm-6pm") }} className="time-slots-btn-offerride btn-default black-color time-slots-btns">3pm-6pm</button>

                                                                <button value={time} style={styleButton5} onClick={(event) => { handleTimeRequest(event, "6pm-9pm") }} className="time-slots-btn-offerride btn-default black-color time-slots-btns">6pm-9pm</button>
                                                    ...
                                                    <button onClick={(event) => { nextClick(event);manageShow() }} className="next purple-color">Next&gt;&gt;</button>
                                                </form>
                                            </div>
                            ...
                            { openEmp && <Col sm={4} lg={6} xl={4} className="offer-ride-card-column">
                                            ...
                                            <div>
                                                <form className="form-for-offering">
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <Row>
                                                            <div>
                                                                <button value={seats} style={styleButton6} onClick={(event) => { handleSeats(event, 1) }} className="seat-slot-btn-offerride btn-default black-color seat-slots-btns">1</button>
                                                                <button value={seats} style={styleButton7} onClick={(event) => { handleSeats(event, 2) }} className="seat-slot-btn-offerride btn-default black-color seat-slots-btns">2</button>
                                                                <button value={seats} style={styleButton8} onClick={(event) => { handleSeats(event, 3) }} className="seat-slot-btn-offerride btn-default black-color seat-slots-btns">3</button>
                                                    ...
                                                    <input
                                                        type="button"
                                                        className="btn-offerride-submit btn-default"
