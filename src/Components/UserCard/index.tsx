...
const UserCard: React.FC<props> = ({ rideId, rideProviderId, sourceId, destinationId, date, fair, totalSeats, availableSeats, time, seatsBooked,userName,image }) => {
    ...
    const addBookRideToBackend = async () => {
        ...
        await axiosInstance.post('http://localhost:5290/api/BookRide/Booking',
            {
